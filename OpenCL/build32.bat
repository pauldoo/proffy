...
REM set COMPILE_OPTIONS=/openmp /Ox /fp:fast /arch:SSE2 /Zi /W4 /TC /MD /D_CRT_SECURE_NO_WARNINGS /I "C:\Program Files (x86)\ATI Stream\include"
set COMPILE_OPTIONS=/openmp /Ox /fp:fast /arch:SSE2 /Zi /W4 /TC /MD /D_CRT_SECURE_NO_WARNINGS /I "C:\ProgramData\NVIDIA Corporation\NVIDIA GPU Computing SDK\OpenCL\common\inc"
set SOURCE_FILES=main.c common.c warpopencl.c warpvanilla.c warpvanilla2.c warpvanillaf.c warpopenmp.c
